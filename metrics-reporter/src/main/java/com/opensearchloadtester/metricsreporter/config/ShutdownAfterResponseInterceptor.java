...
/**
 * Intercepts HTTP requests to trigger a controlled shutdown of the Metrics Reporter after the
 * response has been fully sent to the client.
 *
 * <p>The shutdown is initiated only when explicitly requested via a request attribute and supports
 * custom exit codes to distinguish between successful runs, load generator failures, and internal
 * reporter errors.
 */
@Slf4j
@Component
