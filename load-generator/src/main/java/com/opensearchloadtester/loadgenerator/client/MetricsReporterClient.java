  ...
  public void sendMetrics(List<MetricsDto> metricsList) {
    ...
    for (int attempt = 1; attempt <= maxAttempts; attempt++) {
      try {
        ...
        log.warn("Failed to send metrics (attempt: {}/{}, HTTP: {})", attempt, maxAttempts, status);
        ...
        log.warn("I/O error while sending metrics (attempt: {}/{})", attempt, maxAttempts, e);
