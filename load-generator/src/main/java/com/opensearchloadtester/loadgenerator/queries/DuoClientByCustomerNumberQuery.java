...
public class DuoClientByCustomerNumberQuery extends AbstractQuery {
  ...
  private DuoClientByCustomerNumberQuery(
  ...
  public static DuoClientByCustomerNumberQuery random() {
    ...
    Map<String, String> queryParams = Map.of("customer_number", customerNumber);

    return new DuoClientByCustomerNumberQuery(
        queryParams, "query-templates/q7_duo_client_by_customer_number.json");
  }
}
